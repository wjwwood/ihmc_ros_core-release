...
The packages in the `ihmc_ros_core` repository were released into the `indigo` distro by running `/usr/local/bin/bloom-release -r indigo -t indigo ihmc_ros_core --override-release-repository-url https://github.com/wjwwood/ihmc_ros_core-release` on `Thu, 23 Feb 2017 18:33:27 -0000`
